...
# Load EfficientNet-B5 và MobileNetV2
...
def train_model(model, criterion, early_stopping, optimizer, num_epochs=50, grad_clip=1.0):
    ...
    with open('efficientnet_b5+mobilenetv2_log.csv', 'w') as log_file:
...
def evaluate_model(model, dataloader):
    ...
    with open('efficientnet_b5+mobilenetv2_log.csv', 'a') as log_file:
...
with open('efficientnet_b5+mobilenetv2_log.csv', 'a') as f:
