...
# Load EfficientNet-b5 và ResNet50
...
def train_model(model, criterion, early_stopping, optimizer, num_epochs=50, grad_clip=1.0):
    ...
    with open('efficientnet_b5+Resnet50_log.csv', 'w') as log_file:
...
plot_confusion_matrix(model, dataloaders['val'], dataset.classes, 'efficientnet-b5+Resnet50_val_cm.png')
# Plot confusion matrix for test set
plot_confusion_matrix(model, test_loader, dataset_2.classes, 'efficientnet-b5+Resnet50_test_cm.png')
...
with open('efficientnet_b5+Resnet50_log.csv', 'a') as f:
