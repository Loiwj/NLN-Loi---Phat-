...
def train_model(model, criterion, early_stopping, optimizer, num_epochs=50, grad_clip=1.0):
    ...
    with open('efficientnet_b5+V3_log.csv', 'w') as log_file:
...
def evaluate_model(model, dataloader):
    ...
    with open('efficientnet_b5+V3_log.csv', 'a') as log_file:
...
plot_confusion_matrix(model, dataloaders['val'], dataset.classes, 'efficientnet_b5+V3_log_val_cm.png')
# Plot confusion matrix for test set
plot_confusion_matrix(model, test_loader, dataset_2.classes, 'efficientnet_b5+V3_log_test_cm.png')
...
with open('efficientnet_b5+V3_log.csv', 'a') as f:
