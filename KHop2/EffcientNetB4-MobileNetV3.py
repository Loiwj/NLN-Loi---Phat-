...
# Load EfficientNet-B4 và MobileNetV3
...
plot_confusion_matrix(model, dataloaders['val'], dataset.classes, 'efficientnet_b4+V3_log_val_cm.png')
# Plot confusion matrix for test set
plot_confusion_matrix(model, test_loader, dataset_2.classes, 'efficientnet_b4+V3_log_test_cm.png')
...
with open('efficientnet_b4+V3_log.csv', 'a') as f:
